...
namespace GameFramework.Resource
{
    internal sealed partial class ResourceManager : GameFrameworkModule, IResourceManager
    {
        ...
        private sealed partial class ResourceLoader
        {
            ...
            {
                Debug.LogWarning("ResourceManager.ResourceLoader scene asset name:" + sceneAssetName);
                ResourceInfo resourceInfo = null;
                string[] dependencyAssetNames = null;
            ...
            private bool CheckAsset(string assetName, out ResourceInfo resourceInfo, out string[] dependencyAssetNames)
            {
                ...
                if (assetInfo == null)
                {
                    Debug.LogError(" m_ResourceManager.GetAssetInfo is null:" + assetName);
                    return false;
                }
                ...
                if (resourceInfo == null)
                {
                    Debug.LogError(" m_ResourceManager.GetResourceInfo is null:" + assetInfo.ResourceName);
                    return false;
                }
